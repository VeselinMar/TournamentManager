...
from .views import HomePageView, TeamCreateView, MatchCreateView, MatchDetailView, MatchEditView, TopScorersView, TeamLeaderboardView
...
urlpatterns = [
    ...
    path('leaderboard/teams/', TeamLeaderboardView.as_view(), name='team-leaderboard'),
]
